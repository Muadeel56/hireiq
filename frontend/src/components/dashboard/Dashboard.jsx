        ...
        <div className="space-y-4">
          <div className="flex items-center space-x-4">
            ...
            <div className="flex-1">
              <p className="text-sm font-medium text-gray-900">Profile viewed by TechCorp</p>
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="flex-1">
              <p className="text-sm font-medium text-gray-900">Application submitted for Senior Developer</p>
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="flex-1">
              <p className="text-sm font-medium text-gray-900">New message from HR Manager</p>
        ...
        <div>
          ...
          <div className="flex items-center mt-2">
            <span className={`px-3 py-1 rounded-full text-xs font-medium ${
              ...
              {user?.user_type === 'candidate' ? 'Candidate' : 'Recruiter'}
            </span>
            {user?.profile?.company_name && (
              <span className="ml-2 text-sm text-gray-500">at {user.profile.company_name}</span>
            )}
          </div>
        </div>
      </div>
